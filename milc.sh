#!/bin/bash
./build/X86/gem5.opt -d stats/milc configs/deprecated/example/se.py \
...
-F 100000 -s 200000 -W 10000000 -I 10000000 \
-c /home/kpvivek/ca_gem5/benchspec/CPU2006/433.milc/exe/milc_base.gcc43-64bit \
